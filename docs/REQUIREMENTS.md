...
| 9.5 | Teacher CPT for public instructor identity, optionally linked to a WP user | ✅ repo (`teacher` CPT + `_hedayati_teacher_user_id` 1:1) — not publicly routed yet (D30) |
